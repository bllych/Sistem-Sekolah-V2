...
@section('content')
    ...
    <form action="" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8">
        <div>
            <label for="nip" class="mb-1.5 block text-xs font-semibold uppercase widest-[0.1em] text-[#16213A]">NIP</label>
            <input type="text" id="nip" name="nip" value="{{ $teacher['nip'] }}"
                class="w-full border border-[#D9D6CD] bg-[#FCFBF8] px-3.5 py-2.5 text-sm focus:border-[#A16207] focus:bg-white focus:outline-none">
        </div>

        <div>
            <label for="name" class="mb-1.5 block text-xs font-semibold uppercase widest-[0.1em] text-[#16213A]">Nama
                Lengkap</label>
        ...
        <div>
            <label for="gender" class="mb-1.5 block text-xs font-semibold uppercase widest-[0.1em] text-[#16213A]">Jenis
                Kelamin</label>
        ...
        <div>
            <label for="subject" class="mb-1.5 block text-xs font-semibold uppercase widest-[0.1em] text-[#16213A]">Mata
                Pelajaran</label>
        ...
        <div>
            <label for="phone_number"
                class="mb-1.5 block text-xs font-semibold uppercase widest-[0.1em] text-[#16213A]">Nomor Telepon</label>
        ...
        <div>
            <label for="status"
                class="mb-1.5 block text-xs font-semibold uppercase widest-[0.1em] text-[#16213A]">Status</label>
