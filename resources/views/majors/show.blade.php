...
@section('content')
    ...
    <a href="{{ route('majors.index') }}" class="text-xs uppercase widest[0.15em] text-slate-400 hover:text-[#A16207]">
        &larr; Buku Induk
    </a>
    ...
    <div class="mt-3 border border-[#E5E3DB] bg-white">
        ...
        <div class="flex items-start justify-between border-b border-[#E5E3DB] bg-[#FCFBF8] px-8 py-6">
            <div>
                <p class="mb-1 text-[11px] uppercase tracking-[0.2em] text-[#A16207]">Keterangan Jurusan</p>
        ...
        <dl class="divide-y divide-[#EFEDE6] text-sm">
            ...
            <div class="flex justify-between px-8 py-4">
                <dt class="uppercase widest-[0.1em] text-xs text-slate-400">Kode Jurusan</dt>
                <dd class="font-medium text-[#16213A]">{{ $major['code'] }}</dd>
            </div>
            <div class="flex justify-between px-8 py-4">
                <dt class="uppercase widest-[0.1em] text-xs text-slate-400">Nama Jurusan</dt>
                <dd class="font-medium text-[#16213A]">{{ $major['name'] }}</dd>
            </div>
            <div class="flex justify-between px-8 py-4">
                <dt class="uppercase widest-[0.1em] text-xs text-slate-400">Deskripsi</dt>
