...
@section('content')
    ...
    <form action="" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8">
        <div>
            <label for="code" class="mb-1.5 block text-xs font-semibold uppercase widest-[0.1em] text-[#16213A]">Kode
                Jurusan</label>
        ...
        <div>
            <label for="description" class="mb-1.5 block text-xs font-semibold uppercase widest[0.1em] text-[#16213A]">
                Deskripsi</label>
